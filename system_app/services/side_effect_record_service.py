    ...
    if source_trace_id:
        existing = session.scalar(
            ...
            .where(
                ...
                SideEffectRecord.source_trace_id == source_trace_id,
                SideEffectRecord.source_event_type == request.source_event_type,
                SideEffectRecord.medication_name == medication_name,
                SideEffectRecord.symptom_text == request.symptom_text,
            )
            .order_by(desc(SideEffectRecord.id))
        )
